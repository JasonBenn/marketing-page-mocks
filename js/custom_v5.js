jQuery(document).ready(function(){	
	...
	jQuery('#fullpage').fullpage({
		...
		onLeave: function(index, nextIndex, direction){
			...
			// Showing iphone ----------------------------------------------	
				//Hide fixed phone
				if( nextIndex == 1 || nextIndex == 2 || nextIndex == 6 || nextIndex == 7 || nextIndex == 8 || nextIndex == 9){
				...
				if(nextIndex >= 4 && direction == 'down'){
					jQuery('.use-card .iphone').fadeOut(0);
				}
				//Show Sign Up Phone
				if( nextIndex == 2 && direction =='up' ){
					jQuery('.use-card .iphone').fadeIn(0);
				}
			...
			//Showing videos ----------------------------------------------
				//Alert 
				if( nextIndex == 3 ){
					jQuery('#alert').delay(500).fadeIn(300,function(){
						jQuery('#alert').get(0).play();
					});
				}
				if(index == 3 ){
					if(direction == 'up'){ jQuery('#alert').fadeOut(0);}
	...
	*/
		...
		function setHeight(){	
			...
			jQuery('#iphone, #iphone .table, #iphone img, .iphone').height(win_height*0.75).width(iphone_width);
