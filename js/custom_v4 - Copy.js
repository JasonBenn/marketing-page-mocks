jQuery(document).ready(function(){	
	...
	jQuery('#fullpage').fullpage({
		...
		afterRender: function () {
			...
			//if(jQuery('#news-vid').length){ jQuery('#news-vid').get(0).play(); }
			//if(jQuery('#alert').length){ jQuery('#alert').get(0).play(); }
			//if(jQuery('#send-money-vid').length){ jQuery('#send-money-vid').get(0).play(); }
		...
		onLeave: function(index, nextIndex, direction){
			// z-index fix -------------------------------------------------
			if( (index == 1 && nextIndex == 2) || (index == 2 && nextIndex == 3) || index == 3 || index == 4 || (index == 5 && nextIndex == 4) || (index == 6 && nextIndex == 5) ){
